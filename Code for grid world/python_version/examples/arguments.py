...
parser.add_argument("--env-size", type=Union[list, tuple, np.ndarray], default=(5,3) )

# specify the start state
parser.add_argument("--start-state", type=Union[list, tuple, np.ndarray], default=(0,2))
...
parser.add_argument("--forbidden-states", type=list, default=[ (2, 1), (1, 2), (3, 1)] )
...
parser.add_argument("--discount-rate", type=float, default=0.90)
